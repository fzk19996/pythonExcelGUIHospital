...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        muban_filename = 'H:\\work\\code\\python\\gui\\excel\\pyGUI\\doc\\模板.txt'
        self.gridLabel = read_muban(muban_filename)
    ...
    def __set_properties(self):
        ...
        # self.gridNonStandar.CreateGrid(self.gridLabel.shape[0]*2, self.gridLabel.shape[1])
        self.gridNonStandar.CreateGrid(14, 8)
        self.gridNonStandar.SetColSize(0, 120)
        for i in range(self.gridLabel.shape[0]):
            for j in range(1, self.gridLabel[i].shape[0]):
                self.gridNonStandar.SetCellValue(i*2, j, self.gridLabel[i][j])
            self.gridNonStandar.SetCellValue(i*2+1, 0, self.gridLabel[i][0])


        # self.gridNonStandar.SetColLabelValue(0, u"门诊人次")
        # self.gridNonStandar.SetColLabelValue(1, u"住院人次")
        # self.gridNonStandar.SetColLabelValue(2, u"入院人次")
        # self.gridNonStandar.SetColLabelValue(3, u"出院人次")
        # self.gridNonStandar.SetColLabelValue(4, u"病重人次")
        # self.gridNonStandar.SetColLabelValue(5, u"上机人次")
